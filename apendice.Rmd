...
$\qquad\quad\qquad E(\hat{\beta}_0)=E(\bar{Y}-\hat{\beta}_1\bar{X})$  

$\qquad\quad\qquad\quad\qquad=E\bigg(\frac{\sum_{i=1}^{n}Y_i}{n}\bigg)-\hat{\beta}_1\bar{X}\quad\qquad\quad$  

$\qquad\quad\qquad\qquad\quad=\frac{1}{n}E\bigg(\sum_{i=1}^{n}Y_i\bigg)-\hat{\beta}_1\bar{X}\quad$
