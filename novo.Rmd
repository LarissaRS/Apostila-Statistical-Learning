...
Applied Linear Statistical Models 5th pag 33-34

Colocar figura 1.4 do Applied Linear Statistical Models 5th
...
Além das informações assumidas, os estimadores de mínimos quadrados tem distribuição de probabilidade Normal. Segue abaixo o valor esperado e a variância de $\hat{\beta_0}$ e $\hat{\beta_1}$ respectivamente:  
...
* $\hat{\beta_0} \sim N\Bigg(\beta_1,\Bigg)$  
...
Applied Linear Statistical Models 5th (pag 51 - pag 56)  
Aplied regression (pag 78 - pag 80) & pag 88 (capitulo2)
...
Aplied regression (pag 80 - pag 82)


# 1.2.3 Os dois metodos juntos (pah 721)
      
# 1.3 Análise de Resíduos (Openintro)

Applied Linear Statistical Models 5th pg 126
Applied regresion pag 53,54
